 ...
 *
 * extract
 *  extract ankidroiddocs.zip to temp_dir
 *
 * update
 *  copy latest file from temp_dir to po dir
 */
...
process.argv.forEach(function (value) {
    switch (value) {
        ...
        case "extract":
            ...
            extractZip("ankidroiddocs.zip", TEMP_DIR);
            break;

        case "update":
            console.log(
                "Copying downloaded translations to po directory",
            );
            updateI18nFiles();
            break;
    }
