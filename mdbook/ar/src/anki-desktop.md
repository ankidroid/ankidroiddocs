...
=== عبر مزامنة السحابة
قبل أن تستطيع استخدام أنكي ويب، عليك إنشاء حساب من خلال زيارة https://ankiweb.net
...
في شريط التطبيق في أعلى <<deckPicker, قائمة الرزم>>.
...
<<AnkiWebConflicts, حل التعارضات>> قبل الاستمرار.
...
من خلال <<deckPicker, قائمة الرزم>>، انقر زر «مزامنة» في أعلى اليمين (له سهمان في دائرة).
